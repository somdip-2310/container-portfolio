...
public class DockerfileGenerator {
    ...
    public DockerfileGenerator(@Value("${aws.ecr.baseImages.registry}") String ecrRegistry) {
    ...
    public String replaceBaseImages(String dockerfileContent) {
        ...
        modified = modified.replaceAll("(?i)FROM\\s+nginx:alpine", "FROM " + ecrRegistry + "/base-images/nginx:alpine");
        modified = modified.replaceAll("(?i)FROM\\s+nginx:latest", "FROM " + ecrRegistry + "/base-images/nginx:alpine");

        modified = modified.replaceAll("(?i)FROM\\s+node:18-alpine", "FROM " + ecrRegistry + "/base-images/node:18-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+node:18", "FROM " + ecrRegistry + "/base-images/node:18-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+node:latest", "FROM " + ecrRegistry + "/base-images/node:18-alpine");

        modified = modified.replaceAll("(?i)FROM\\s+python:3\\.11-slim", "FROM " + ecrRegistry + "/base-images/python:3.11-slim");
        modified = modified.replaceAll("(?i)FROM\\s+python:3-slim", "FROM " + ecrRegistry + "/base-images/python:3.11-slim");
        modified = modified.replaceAll("(?i)FROM\\s+python:latest", "FROM " + ecrRegistry + "/base-images/python:3.11-slim");

        modified = modified.replaceAll("(?i)FROM\\s+eclipse-temurin:17-jdk-alpine", "FROM " + ecrRegistry + "/base-images/eclipse-temurin:17-jdk-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+eclipse-temurin:17-jre-alpine", "FROM " + ecrRegistry + "/base-images/eclipse-temurin:17-jre-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+openjdk:17-alpine", "FROM " + ecrRegistry + "/base-images/eclipse-temurin:17-jdk-alpine");

        modified = modified.replaceAll("(?i)FROM\\s+golang:1\\.21-alpine", "FROM " + ecrRegistry + "/base-images/golang:1.21-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+golang:alpine", "FROM " + ecrRegistry + "/base-images/golang:1.21-alpine");

        modified = modified.replaceAll("(?i)FROM\\s+alpine:latest", "FROM " + ecrRegistry + "/base-images/alpine:latest");
        modified = modified.replaceAll("(?i)FROM\\s+alpine", "FROM " + ecrRegistry + "/base-images/alpine:latest");

        modified = modified.replaceAll("(?i)FROM\\s+php:8\\.2-fpm-alpine", "FROM " + ecrRegistry + "/base-images/php:8.2-fpm-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+php:fpm-alpine", "FROM " + ecrRegistry + "/base-images/php:8.2-fpm-alpine");

        modified = modified.replaceAll("(?i)FROM\\s+ruby:3\\.2-alpine", "FROM " + ecrRegistry + "/base-images/ruby:3.2-alpine");
        modified = modified.replaceAll("(?i)FROM\\s+ruby:alpine", "FROM " + ecrRegistry + "/base-images/ruby:3.2-alpine");
    ...
    private String generateNodeJsDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/node:18-alpine AS builder\n\n");
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/node:18-alpine\n\n");
        dockerfile.append("WORKDIR /app\n\n");
    ...
    private String generatePythonDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/python:3.11-slim\n\n");
        dockerfile.append("WORKDIR /app\n\n");
    ...
    private String generateJavaMavenDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/eclipse-temurin:17-jdk-alpine AS builder\n\n");
        ...
        // Production stage
        dockerfile.append("# Production stage\n");
        dockerfile.append("FROM " + ecrRegistry + "/base-images/eclipse-temurin:17-jre-alpine\n\n");
        dockerfile.append("WORKDIR /app\n\n");
    ...
    private String generateGoDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/golang:1.21-alpine AS builder\n\n");
        dockerfile.append("WORKDIR /app\n\n");
        ...
        // Production stage
        dockerfile.append("# Production stage\n");
        dockerfile.append("FROM " + ecrRegistry + "/base-images/alpine:latest\n\n");
    ...
    private String generatePhpDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/php:8.2-fpm-alpine\n\n");
    ...
    private String generateRubyDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/ruby:3.2-alpine\n\n");
        dockerfile.append("WORKDIR /app\n\n");
    ...
    private String generateDotNetDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/dotnet-sdk:7.0-alpine AS builder\n\n");
        dockerfile.append("WORKDIR /app\n\n");
        ...
        // Production stage
        dockerfile.append("# Production stage\n");
        dockerfile.append("FROM " + ecrRegistry + "/base-images/dotnet-aspnet:7.0-alpine\n\n");
        dockerfile.append("WORKDIR /app\n\n");
    ...
    private String generateStaticHtmlDockerfile(ProjectAnalyzer.ProjectInfo info) {
        ...
        dockerfile.append("FROM " + ecrRegistry + "/base-images/nginx:alpine\n\n");
